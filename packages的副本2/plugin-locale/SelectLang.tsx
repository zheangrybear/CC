...
import { getAllLocales, getLocale, setLocale } from './index';
...
export const SelectLang: React.FC<SelectLangProps> = (props) => {
  const { globalIconClassName, postLocalesData, onItemClick, reload, ...restProps } = props;
  const selectedLang = getLocale();

  const changeLang = ({ key }): void => setLocale(key, reload);
