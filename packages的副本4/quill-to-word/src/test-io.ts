...
import type { ParsedQuillDelta, RawQuillDelta } from '../../quilljs-parser';
...
export const simple_paragraph_input: DocInputTest = {
  ops: [
    {
      insert:
        'This is a simple paragraph written into the Quill editor. This will just be a test of the docx exporting feature.',
    },
  ],
};
    ...
    numbering: {
      config: [
        ...
        },
        {
          ...
          // @ts-ignore:next-line
          levels: customNumberedLevels, // @ts-ignore
        },
      ],
    },
    hyperlinks: undefined,
...
export const custom_styles_delta: DocInputTest = {
  ops: [
    ...
    {
      insert:
        'Here is just some basic text writing into the document.\nThen we start a new paragraph in the editor.\nA Level Two Heading',
    },
    {
      insert: '\n',
      attributes: {
...
function customHeader() {
  ...
  const index = style.findIndex((s) => s.id === 'header_1');
