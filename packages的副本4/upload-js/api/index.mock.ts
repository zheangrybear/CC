import { UploadNetworkError, UploadRequestError } from '../errors'
import * as api from '.'

export const errorMap = {
  networkError: new UploadNetworkError('mock', 'message'), // 网络错误

  invalidParams: new UploadRequestError(400, 'mock', 'message'), // 无效的参数
  expiredToken: new UploadRequestError(401, 'mock', 'message'), // token 过期

  gatewayUnavailable: new UploadRequestError(502, 'mock', 'message'), // 网关不可用
  serviceUnavailable: new UploadRequestError(503, 'mock', 'message'), // 服务不可用
  serviceTimeout: new UploadRequestError(504, 'mock', 'message'), // 服务超时
  serviceError: new UploadRequestError(599, 'mock', 'message'), // 服务错误

  invalidUploadId: new UploadRequestError(612, 'mock', 'message') // 无效的 upload id
}
