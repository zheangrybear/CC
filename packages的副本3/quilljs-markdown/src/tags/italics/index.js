    ...
    return {
      ...
      action: (text, selection, pattern, lineStart) => new Promise((resolve) => {
        ...
        setTimeout(() => {
          ...
          this.quillJS.deleteText(adjustPosition, deleteEndOffset, Quill.sources.USER)
          this.quillJS.insertText(adjustPosition, matchedText, { italic: true }, Quill.sources.USER)
          this.quillJS.format('italic', false, Quill.sources.USER)
