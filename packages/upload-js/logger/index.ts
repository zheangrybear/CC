import type { V3LogInfo } from './report-v3';
...
export default class Logger {
  ...
  constructor(token: string, disableReport = true, level: LogLevel = 'OFF', prefix = 'UPLOAD') {
    this.token = token;
  ...
  private getPrintPrefix(level: LogLevel) {
    return `Upload-JS-SDK [${level}][${this.prefix}#${this.id}]:`;
  }
